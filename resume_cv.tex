...
\name{Igor D.}{Ilić}
\address{Mihaila Avramovića 9, Apt. 5, 11040 Belgrade, Rep. of Serbia}
\mobile{(+381) 63-1564-983}

\email{ilicigor@gmail.com}
\homepage{www.igorilic.com}
\github{igorilic}
\linkedin{ilicigor}
%\skype{skypeid}
\stackoverflow{5453034}{igor-ilić}
\twitter{@igordilic}

\position{Software Engineer{\enskip\cdotp\enskip}Javascript Angular2 NodeJs} % Your expertise/fields
% \quote{``Make the change that you want to see in the world."} % A quote or statement

\makecvfooter{\today}{Igor D. Ilić~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
